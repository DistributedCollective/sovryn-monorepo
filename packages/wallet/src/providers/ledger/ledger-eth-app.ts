 ...
 ********************************************************************************/
// FIXME drop:
import { splitPath, foreach } from '@ledgerhq/hw-app-eth/lib-es/utils';
...
export default class Eth {
  ...
  starkSignOrder_v2(
    ...
    sourceQuantization,
    sourceMintableBlobOrTokenId,
    destinationTokenAddress,
    destinationQuantizationType,
    destinationQuantization,
    destinationMintableBlobOrTokenId,
    sourceVault,
    destinationVault,
    amountSell,
    amountBuy,
  ...
  starkProvideQuantum_v2(
    ...
    operationMintableBlobOrTokenId,
  ) {
    const operationContractHex = maybeHexBuffer(operationContract);
